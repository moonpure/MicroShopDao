...
public class MallbannerController {
    ...
    @GetMapping("/banner/deletebyprimarykey/{id}")
   public int deleteByPrimaryKey(@PathVariable Integer id)
   {
    ...
    @GetMapping("/banner/selectbyprimarykey/{id}")
    ...
    @GetMapping("/banner/updatebyprimarykeyselective")
    ...
    @GetMapping("/banner/updatebyprimarykey")
